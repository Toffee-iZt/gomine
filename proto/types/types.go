...
import (
	...
	"github.com/Toffee-iZt/gomine/proto/nbt"
	"github.com/google/uuid"
)

// Field is both Encoder and Decoder
type Field interface {
	Encoder
	Decoder
}

// Encoder can be encode as minecraft protocol used.
type Encoder io.WriterTo

// Decoder can Decode from minecraft protocol
type Decoder io.ReaderFrom
...
type (
	...
	// ByteArray is a sequence of zero or more bytes
	ByteArray []byte
)
...
// WriteTo encodes a Signed Short
...
// WriteTo encodes a Unsigned Short
...
// ReadFrom decodes a UnsignedShort
...
// NBT encodes a value as Named Binary Tag
